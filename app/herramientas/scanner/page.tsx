...
import { WitxScanner } from "@/components/WitxScanner";
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="text-center">
          ...
          <h1 className="mb-4 text-4xl font-bold tracking-tight md:text-5xl">
            WITX <span style={{ color: "#23e7ff" }}>Scanner</span>
          </h1>
          <p className="mx-auto mb-10 max-w-2xl text-lg text-zinc-400">
            Pega la mint address de cualquier token de Solana y analiza su salud
            de mercado: liquidez, volumen, presión de venta y un veredicto rápido.
          </p>
        </div>
